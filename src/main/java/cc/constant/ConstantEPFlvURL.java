...
public class ConstantEPFlvURL {
    ...
    private static String regexStart="\\<script\\>window\\.__INITIAL_STATE__=";
    private static String regexEnd=";\\(function\\(\\)\\{var s;\\(s=document\\.currentScript\\|\\|document\\.scripts\\[document\\.scripts\\.length-1\\]\\)\\.parentNode\\.removeChild\\(s\\);\\}\\(\\)\\);\\</script\\>";
